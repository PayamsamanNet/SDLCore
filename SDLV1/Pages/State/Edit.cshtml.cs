    ...
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGet(string Id)
        {
            try
            {
                ...
                var Result = Client.GetAsync("api/States/GetById?Id=" + Id + "").Result;
                if (Result.IsSuccessStatusCode)
                {
                    State = Result.Content.ReadFromJsonAsync<StateDto>().Result;
                    return Page();
                }
                else
                {
        ...
        public async Task<IActionResult> OnPost()
        {
            try
            {
                ...
                else
                {
                    ...
                    var Result = Client.PutAsync("api/States/Update", Content).Result;
                    if (Result.IsSuccessStatusCode)
                    {
