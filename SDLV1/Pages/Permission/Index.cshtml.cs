    ...
    public class IndexModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            try
            {
                ...
                var resualt = client.GetAsync("api/Permission/GetAll").Result;
                if (resualt.IsSuccessStatusCode)
                {
                    var model = resualt.Content.ReadFromJsonAsync<List<PermissionDto>>().Result;
                    Permission = model;
                }
            }
            catch { }
        ...
        public IActionResult OnPostDelete(string Id)
        {
            try
            {
                ...
                var token = User.FindFirst(_settingWeb.TokenName).Value;
                client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(_settingWeb.TokenType, token);
                var Result = client.DeleteAsync("api/Permission/Delete?Id=" + Id + "").Result;
